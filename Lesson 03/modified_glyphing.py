...
def main():
    ...
    sphereSource.SetThetaResolution(12)  # Set the number of divisions along the longitude
    sphereSource.SetPhiResolution(12)  # Set the number of divisions along the latitude
    ...
    renderer.SetBackground(1, 0.6, 0.5)  # Set background to white
