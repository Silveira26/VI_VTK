...
def createCubeActor(sideLength, position, color, ren):
    ...
    cubeActor.GetProperty().LightingOff()  # This turns off lighting effects on the cube
...
def main():
    ...
    createCubeActor(1, (-5,0,0), (1,0,0), ren)
    createCubeActor(1, (0,0,-5), (0,1,0), ren)
    createCubeActor(1, (5,0,0), (0,0,1), ren)
    createCubeActor(1, (0,0,5), (1,1,0), ren)
